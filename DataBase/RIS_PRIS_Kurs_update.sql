...
/* Created on:     20.12.2022 16:19:01                          */
/*==============================================================*/
...
create table Material (
   ...
   N_page               tinyint              null,
   Deadline_write       datetime             not null check (Deadline_write >= GETDATE()),
   Deadline_design      datetime             not null check (Deadline_design >= GETDATE()),
